...
#+BEGIN_NOTES
1) How to scope content to a specific branch?
2) Each dummy branch location got its own Browse Category Group; e.g., the Madison-Display location is assigned a Browse Category Group called Madison-Display.
#+END_NOTES
** 
